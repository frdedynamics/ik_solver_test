...
env.Load('ur5-vertical.xml') # load a scene
...
robot.SetDOFValues([0.0,1.57,1.57,0.0,0.0,0.0])
manip = robot.GetActiveManipulator()
print "IK solver:", manip.GetIkSolver()
raw_input('Cont?')
...
sol = ikmodel.manip.FindIKSolution(Tgoal,IkFilterOptions.CheckEnvCollisions)
robot.SetDOFValues(sol,ikmodel.manip.GetArmIndices())
basemanip.MoveToHandPosition([Tgoal],maxiter=1000,maxtries=1,seedik=4)
