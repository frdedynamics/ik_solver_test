...
joint_angles = [0.1,-0.75,0.2,1.5,-0.6,0.] # in radians
...
null_ee = np.array([[ 0., 1., 0., 0.8172000050544739],
                    [ 1.0, 0., 0., 0.0812000036239624],
                    [ 0., 0., -1.0, 0.06289999932050705]])
...
ee_pose_test2 = np.array([[ 0.35469, -0.51845, -0.77807, 0.520],
                          [ 0.82533, 0.56464, 0.0, 0.081],
                          [ 0.43933, -0.64217, 0.62817, -0.332]])
